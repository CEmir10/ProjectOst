...
get_filename_component(_filename "/home/ost/catkin_ws/src/randomwalker/srv/GetScore.srv" NAME_WE)
add_custom_target(_randomwalker_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "randomwalker" "/home/ost/catkin_ws/src/randomwalker/srv/GetScore.srv" ""
)

get_filename_component(_filename "/home/ost/catkin_ws/src/randomwalker/srv/GetBounds.srv" NAME_WE)
add_custom_target(_randomwalker_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "randomwalker" "/home/ost/catkin_ws/src/randomwalker/srv/GetBounds.srv" ""
)
...
_generate_srv_cpp(randomwalker
  "/home/ost/catkin_ws/src/randomwalker/srv/GetScore.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/randomwalker
)
_generate_srv_cpp(randomwalker
  "/home/ost/catkin_ws/src/randomwalker/srv/GetBounds.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/randomwalker
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/randomwalker)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/randomwalker\")")
  # install generated code
  install(
