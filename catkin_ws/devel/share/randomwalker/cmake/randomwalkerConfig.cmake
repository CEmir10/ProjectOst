...
if(NOT "/home/ost/catkin_ws/devel/include " STREQUAL " ")
  set(randomwalker_INCLUDE_DIRS "")
  set(_include_dirs "/home/ost/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'randomwalker' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ost/catkin_ws/src/randomwalker/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ost/catkin_ws/devel/lib;/opt/ros/melodic/lib)
